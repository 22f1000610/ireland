# Macroeconomic and Business Analysis of Ireland Datasets

## Overview
This repository contains four CSV datasets for the Macroeconomic Vulnerability Index project at the Centre for Development Studies, Jawaharlal Nehru University. These cover:

1. **Annual Macroeconomic Variables** (1990–2024)  
...
Each file includes precise column definitions, sources, time spans, and notes on data‐processing (imputation, seasonal adjustment, filters).
...
| _…plus several other WDI series (see CSV for full list)_   |                                                                                                   |

---

*(For the full list of all 108 columns, please refer to the header row of the CSV.)*
...
- **Imputation:** Missing annual data for the latest years was sourced directly from CSO and Central Bank; variables with correlation > 0.9 used regression‐based imputation.  
...
- **Data Licensing:** Please cite the original data providers (WDI, OECD, Eurostat, CSO) when publishing results.
